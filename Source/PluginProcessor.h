...
// need inline keyword since this header file is included in multiple scripts and compiler will create defintion 
// in each place and linker won't know which one to use
